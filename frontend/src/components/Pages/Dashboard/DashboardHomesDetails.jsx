...
const { setform , setresponse , response , setdashboard , dashboard} = useContext(info)


  useEffect(() => {
    async function dashbaordDetails (){
const req = await fetch(`http://localhost:4090/dashboardHomeDetails/${_id}`)
...
navigate("/Host")
  ...
  <div className="dashboardhomesdetails-content">
    ...
    <div className="dashboardhomesdetails-actions">
      <button onClick={()=>handleedit(dashboardHomeDetails.home)} className="dashboardhomesdetails-edit-btn">
        Edit
      </button>
